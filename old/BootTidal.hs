...
let rustTarget = superdirtTarget { oPort = 3819 }

-- Initialize Tidal with the custom target instead of the default
tidalInst <- mkTidalWith [(rustTarget, [superdirtShape])] defaultConfig
